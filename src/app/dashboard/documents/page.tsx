      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center rounded-lg border border-white/10 bg-slate-900/50 p-1">
            <button className="rounded-md bg-slate-800 p-1.5 text-white shadow-sm"><LayoutGrid className="h-4 w-4" /></button>
            <button className="rounded-md p-1.5 text-slate-400 hover:text-white"><List className="h-4 w-4" /></button>
          </div>
          <Link
